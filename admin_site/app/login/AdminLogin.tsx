...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (hasAdminSessionCookie() && getAdminToken()) {
  ...
  const handleLogin = async (e?: FormEvent) => {
    ...
    try {
      ...
      setAdminSession(data.token, remember);
      router.replace("/dashboard");
      return;
    } catch {
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Fix It{" "}
              <span style={{ fontWeight: 400, color: "#0F1923" }}>
                Marketplace
              </span>
            </div>
            <div
          ...
          <div style={{ position: "relative" }}>
            ...
            <input
              ...
              onFocus={(e) => {
                ...
                e.target.style.boxShadow = "0 0 0 3px rgba(232,119,34,0.15)";
              }}
              onBlur={(e) => {
                e.target.style.borderColor = "#E3E8F0";
        ...
        >
          ...
          >
            <input
              ...
              style={{ accentColor: "#E87722", width: 15, height: 15 }}
            />
            Remember me
          </label>
          <a
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(232,119,34,0.18) 0%,transparent 60%)",
            top: -150,
            right: -150,
            pointerEvents: "none",
          }}
