  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{
        ...
        {/* Demo hint */}
        <p style={{ textAlign: "center", marginTop: 10, fontSize: 12, color: "#9AA3B8" }}>
          Demo: <strong style={{ color: "#E87722" }}>admin@fixit.com</strong> /{" "}
          <strong style={{ color: "#E87722" }}>admin123</strong>
        </p>
      </div>
