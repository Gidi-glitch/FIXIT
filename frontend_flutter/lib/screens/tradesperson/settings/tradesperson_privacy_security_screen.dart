...
class _TradespersonPrivacySecurityScreenState
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'This is permanent. All your jobs, reviews, and profile data will be erased and cannot be recovered.',
  ...
  // ── Password section ─────────────────────────────────────────────
  Widget _buildPasswordSection() => _card(
    child: Column(
      children: [
        Material(
  ...
  // ── Sessions section ─────────────────────────────────────────────
  Widget _buildSessionsSection() => _card(
    child: Column(
      children: [
        _sectionHead(
        ...
        _listTile(
          ...
          subtitle: 'Revoke all other active sessions.',
  ...
  // ── Data & Privacy ────────────────────────────────────────────────
  Widget _buildDataPrivacySection() => _card(
    child: Column(
      children: [
        _sectionHead(
        ...
        _toggleTile(
          ...
          subtitle: 'Help improve Fix It with anonymous usage data.',
          value: _shareActivity,
          onChanged: (v) {
            setState(() => _shareActivity = v);
            SharedPreferences.getInstance().then(
              (p) => p.setBool('tp_privacy_share_activity', v),
            );
          },
          showDivider: true,
        ),
        _toggleTile(
          ...
          subtitle: 'Allow Fix It to match you with nearby homeowners.',
          value: _locationAccess,
          onChanged: (v) {
            setState(() => _locationAccess = v);
            SharedPreferences.getInstance().then(
              (p) => p.setBool('tp_privacy_location', v),
            );
          },
          showDivider: true,
        ),
        _listTile(
          ...
          subtitle: 'Export a copy of all data we hold about you.',
          onTap: () => _showSnack(
