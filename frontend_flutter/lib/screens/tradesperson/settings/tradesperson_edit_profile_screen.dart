...
class _TradespersonEditProfileScreenState
  ...
  Future<void> _loadData() async {
    ...
    if (token != null && token.isNotEmpty) {
      try {
        ...
        _syncStringPref(
          prefs,
          'barangay',
          user['barangay'] ?? profile['service_barangay'],
        );
    ...
    setState(() {
      ...
      final b = normalizeCalauanBarangay(prefs.getString('barangay') ?? '');
      _selectedBarangay = kCalauanBarangays.contains(b) ? b : null;
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      for (final e in payload.entries) {
        _syncStringPref(prefs, e.key, e.value);
      }
      final full = '${_firstNameCtrl.text.trim()} ${_lastNameCtrl.text.trim()}'
          .trim();
      _syncStringPref(prefs, 'full_name', full);
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildHint(
                          'Your home barangay — manage your service area separately under "Service Area".',
                        ),
                        const SizedBox(height: 28),
                        _sectionHeader(
                          'Additional Details',
  ...
  Widget _buildHint(String text) => Row(
    children: [
      Icon(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 15,
                  fontWeight: FontWeight.w600,
                  color: isDestructive ? errorRed : textDark,
                ),
              ),
            ],
          ),
...
class _ConfirmDialog extends StatelessWidget {
  ...
  final IconData icon;
  final Color iconColor, confirmColor, cardWhite, textDark, textMuted;
