...
class _TradespersonNotificationsScreenState
  ...
  void _toggle(String key, bool v, VoidCallback update) {
    setState(update);
    _set(key, v);
  }
  ...
  void _toggleMaster(bool v) {
    setState(() {
      _pushAll = v;
      if (!v) {
        _notifNewRequest = _notifHighUrgency = _notifJobAccepted =
            _notifJobStarted = _notifJobCompleted = _notifJobCancelled =
                _notifPaymentReceived = _notifPaymentReminder =
                    _notifNewMessage = _notifMessagePreview = _notifAppUpdates =
                        _notifPromos = _notifTips = false;
      } else {
        _notifNewRequest = _notifHighUrgency = _notifJobAccepted =
            _notifJobStarted = _notifJobCompleted = _notifJobCancelled =
                _notifPaymentReceived = _notifPaymentReminder =
    ...
    for (final e in {
      'tp_notif_push_all': v,
      'tp_notif_new_request': _notifNewRequest,
      'tp_notif_high_urgency': _notifHighUrgency,
      'tp_notif_job_accepted': _notifJobAccepted,
      'tp_notif_job_started': _notifJobStarted,
      'tp_notif_job_completed': _notifJobCompleted,
      'tp_notif_job_cancelled': _notifJobCancelled,
      'tp_notif_payment_received': _notifPaymentReceived,
      'tp_notif_payment_reminder': _notifPaymentReminder,
      'tp_notif_new_message': _notifNewMessage,
      'tp_notif_message_preview': _notifMessagePreview,
      'tp_notif_app_updates': _notifAppUpdates,
      'tp_notif_promos': _notifPromos,
      'tp_notif_tips': _notifTips,
    }.entries) {
      _set(e.key, e.value);
    }
  }
                  ...
                  : ListView(
                      ...
                      children: [
                        ...
                        _buildGroup(
                          ...
                          title: 'New Requests',
                          subtitle:
                              'Alerts when homeowners request your service.',
                          items: [
                            _NotifItem(
                              'New Job Request',
                              'When a homeowner sends a new request.',
                              _notifNewRequest,
                              (v) => _toggle(
                                'tp_notif_new_request',
                                v,
                                () => _notifNewRequest = v,
                              ),
                            ),
                            _NotifItem(
                              'High Urgency Alert',
                              'Extra alert for high-urgency requests.',
                              _notifHighUrgency,
                              (v) => _toggle(
                                'tp_notif_high_urgency',
                                v,
                                () => _notifHighUrgency = v,
                              ),
                            ),
                        ...
                        _buildGroup(
                          ...
                          items: [
                            _NotifItem(
                              ...
                              'When your acceptance is confirmed.',
                              _notifJobAccepted,
                              (v) => _toggle(
                                'tp_notif_job_accepted',
                                v,
                                () => _notifJobAccepted = v,
                              ),
                            ),
                            _NotifItem(
                              'Job Started',
                              'When a job transitions to In Progress.',
                              _notifJobStarted,
                              (v) => _toggle(
                                'tp_notif_job_started',
                                v,
                                () => _notifJobStarted = v,
                              ),
                            ),
                            _NotifItem(
                              ...
                              _notifJobCompleted,
                              (v) => _toggle(
                                'tp_notif_job_completed',
                                v,
                                () => _notifJobCompleted = v,
                              ),
                            ),
                            _NotifItem(
                              'Job Cancelled',
                              'When a homeowner cancels a booking.',
                              _notifJobCancelled,
                              (v) => _toggle(
                                'tp_notif_job_cancelled',
                                v,
                                () => _notifJobCancelled = v,
                              ),
                            ),
                          ],
                        ),
                        ...
                        _buildGroup(
                          ...
                          items: [
                            _NotifItem(
                              'Payment Received',
                              'When a homeowner releases your payment.',
                              _notifPaymentReceived,
                              (v) => _toggle(
                                'tp_notif_payment_received',
                                v,
                            ...
                            _NotifItem(
                              'Payment Reminder',
                              'Remind the homeowner to settle payment.',
                              _notifPaymentReminder,
                              (v) => _toggle(
                                'tp_notif_payment_reminder',
                                v,
                                () => _notifPaymentReminder = v,
                              ),
                            ),
                          ],
                        ),
                        ...
                        _buildGroup(
                          ...
                          items: [
                            _NotifItem(
                              'New Message',
                              'When a homeowner sends you a message.',
                              _notifNewMessage,
                              (v) => _toggle(
                                'tp_notif_new_message',
                                v,
                                () => _notifNewMessage = v,
                              ),
                            ),
                            _NotifItem(
                              ...
                              _notifMessagePreview,
                              (v) => _toggle(
                                'tp_notif_message_preview',
                                v,
                        ...
                        _buildGroup(
                          ...
                          items: [
                            _NotifItem(
                              'App Updates',
                              'New features and Fix It improvements.',
                              _notifAppUpdates,
                              (v) => _toggle(
                                'tp_notif_app_updates',
                                v,
                                () => _notifAppUpdates = v,
                              ),
                            ),
                            _NotifItem(
                              'Promotions',
                              'Seasonal offers and platform events.',
                              _notifPromos,
                              (v) => _toggle(
                                'tp_notif_promos',
                                v,
                            ...
                            _NotifItem(
                              ...
                              'Pro tips on better service delivery.',
                              _notifTips,
                              (v) => _toggle(
                                'tp_notif_tips',
                                v,
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Switch.adaptive(
                        value: _pushAll ? item.value : false,
                        onChanged: _pushAll ? item.onChanged : null,
  ...
  Widget _buildFootnote() => Row(
    ...
    children: [
      ...
      Expanded(
        child: Text(
          'You can also manage notification permissions from your device Settings → Apps → Fix It Marketplace.',
          style: TextStyle(
            fontSize: 12,
