...
class _PrivacySecurityScreenState extends State<PrivacySecurityScreen> {
  ...
  Future<void> _loadPrivacyPrefs() async {
    ...
    if (!mounted) return;
    setState(() {
      _shareActivityData = p.getBool('privacy_share_activity') ?? false;
      _allowLocationTracking = p.getBool('privacy_location') ?? true;
    });
  }
  ...
  Future<void> _changePassword() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() => _pwSectionExpanded = false);
      _showSnack(
  ...
  void _showDeleteAccountDialog() async {
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                'All your bookings, messages, and data will be deleted.',
    ...
    if (confirmed == true && mounted) {
      // In a real app, call ApiService.deleteAccount(token) here
      final prefs = await SharedPreferences.getInstance();
      await prefs.clear();
      if (!mounted) return;
      ...
      child: Column(
        children: [
          ...
          Material(
            ...
            child: InkWell(
              onTap: () =>
                  setState(() => _pwSectionExpanded = !_pwSectionExpanded),
              borderRadius: _pwSectionExpanded
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    AnimatedRotation(
                      turns: _pwSectionExpanded ? 0.5 : 0,
          ...
          AnimatedCrossFade(
                ...
                child: Column(
                  children: [
                    ...
                    _buildPwField(
                      ...
                      validator: (v) => v?.trim() != _newPwCtrl.text.trim()
            ...
            crossFadeState: _pwSectionExpanded
  ...
  Widget _buildPasswordRules() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: _infoBlue.withValues(alpha: 0.06),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: _infoBlue.withValues(alpha: 0.15)),
      ),
      child: Column(
        children: rules
            .map(
                ...
                child: Row(
                  children: [
                    Icon(
                      ...
                      size: 14,
                      color: _infoBlue.withValues(alpha: 0.8),
                    ),
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 12,
                        color: _infoBlue.withValues(alpha: 0.9),
                        fontWeight: FontWeight.w500,
                      ),
                    ),
                  ],
      ...
      child: Column(
        children: [
          ...
          _buildListTile(
            ...
            subtitle: 'Revoke all active sessions except this one.',
            onTap: () => _showSnack(
      ...
      child: Column(
        children: [
          ...
          _buildToggleTile(
            ...
            subtitle: 'Help us improve Fix It by sharing anonymous usage data.',
            value: _shareActivityData,
            onChanged: (v) {
              setState(() => _shareActivityData = v);
              _setPrivacyPref('privacy_share_activity', v);
            },
            showDivider: true,
          ),
          _buildToggleTile(
            ...
            subtitle:
                'Allow Fix It to use your location for nearby tradespeople.',
            value: _allowLocationTracking,
            onChanged: (v) {
              setState(() => _allowLocationTracking = v);
              _setPrivacyPref('privacy_location', v);
            },
            showDivider: true,
          ),
          _buildListTile(
            ...
            subtitle: 'Get a copy of all data we hold about you.',
            onTap: () => _showSnack(
              'Data request submitted. We\'ll email you within 48 hours.',
              _primaryBlue,
              icon: Icons.check_circle_rounded,
            ),
            showDivider: false,
