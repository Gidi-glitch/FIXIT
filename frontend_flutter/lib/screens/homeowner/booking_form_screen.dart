...
class _BookingFormScreenState extends State<BookingFormScreen> {
  ...
  String? _validateSchedule() {
    ...
    final timeUntilSchedule = scheduledDateTime.difference(now);

    if (timeUntilSchedule <= const Duration(minutes: 40)) {
      return 'Booking must be scheduled at least 40 minutes in advance';
    }
  ...
  Future<void> _confirmBooking() async {
    ...
    // Validate schedule (must be at least 40 minutes in advance)
